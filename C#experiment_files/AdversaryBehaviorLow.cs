...
// This script controls the movements of the object attached to it.

// Typically this will be an adversary in the unity environment.
// The adversary follows a pre-specified hard-coded patrol until it sees a
// person (facing the location of the person and no buildings are in the way).
// Then it chases after the person. If the person is out of sight for a set time,
// it stops chasing and return to its patrol. If it reaches the person (within a
// certain distance), it changes a public value controlling the health of the
// player. Variables in the beginning can be changes to tune the game.

// To run, attach this c# script to the unity game object. This script can be
// attached to game objects for adversaries 0, 1, and 2. The SerializeField private
// variable must be edited in unity to do this.

// Note that building locations are hard coded into this script to prevent the
// person from walking into a building.

// Right now the adversary constantly checks if it sees the player. It choses
// a new goal every time it sees the play. Both could be computationally expensive.
...
public class AdversaryBehaviorLow : MonoBehaviour
{
    ...
    public static float walkSpeed = 0.3f; //0.1f
    ...
    readonly private int initialize_dist_to_player = 5; //15
    readonly private double line_of_sight = 15; //10
    ...
    private void populate_buildings()
    {
        ...
        int[] bld_small_x_unity = {0, 1, 4, 5, 14, 15, 24, 25, 28, 29, // Row 1.1
                     ...
                     0, 1, 14, 15, 24, 25, 28, 29, // Row 2.1
                     0, 1, 14, 15, 24, 25, 28, 29, // Row 2.2
                     0, 1, 14, 15, 24, 25, 28, 29, // Row 5.1
                     0, 1, 14, 15, 24, 25, 28, 29, // Row 5.2
                     0, 1, 4, 5, 14, 15, 24, 25, 28, 29, // Row 8.1
                     0, 1, 4, 5, 14, 15, 24, 25, 28, 29, // Row 8.2
                     0, 1, 14, 15, 24, 25, 28, 29, // Row 9.1
                     0, 1, 14, 15, 24, 25, 28, 29}; // Row 9.2
        ...
        int[] bld_2horiz_x_unity = {8, 9, 10, 11, 18, 19, 20, 21, // Row 1.1
                      ...
                      8, 9, 10, 11, // Row 2.1
                      8, 9, 10, 11, // Row 2.2
                      8, 9, 10, 11, 18, 19, // Row 5.1
                      8, 9, 10, 11, 18, 19, // Row 5.2
        ...
        int[] bld_2horiz_y_unity = {0, 0, 0, 0, 0, 0, 0, 0, // Row 1.1
                      ...
                      4, 4, 4, 4, // Row 2.1
                      5, 5, 5, 5, // Row 2.2
                     14, 14, 14, 14, 14, 14, // Row 5.1
                     15, 15, 15, 15, 15, 15, // Row 5.2
                     24, 24, 24, 24, 24, 24, 24, 24, // Row 8.1
                     25, 25, 25, 25, 25, 25, 25, 25, // Row 8.2
                     28, 28, 28, 28, 28, 28, 28, 28,  // Row 9.1
                     29, 29, 29, 29, 29, 29, 29, 29 }; // Row 9.2
                                                       // Add vertical buildings
        int[] bld_2vert_x_unity = {0, 1, 4, 5, 14, 15, 28, 29, // Row 3/4.1
                   0, 1, 4, 5, 14, 15, 28, 29, // Row 3/4.2
                   0, 1, 4, 5, 14, 15, 24, 25, 28, 29, // Row 3/4.3
                   0, 1, 4, 5, 14, 15, 24, 25, 28, 29, // Row 3/4.4
                   0, 1, 4, 5, 14, 15, 28, 29, // Row 6/7.1
                   0, 1, 4, 5, 14, 15, 28, 29, // Row 6/7.2
                   0, 1, 4, 5, 14, 15, 24, 25, 28, 29, // Row 6/7.3
                   0, 1, 4, 5, 14, 15, 24, 25, 28, 29 }; // Row 6/7.4
        int[] bld_2vert_y_unity = {8, 8, 8, 8, 8, 8, 8, 8, // Row 3/4.1
        ...
        // Add large buildings
        int[] bld_large_x_unity = {18, 19, 20, 21,  // Row 3/4.1
                    18, 19, 20, 21,  // Row 3/4.2
                    18, 19, 20, 21, // Row 6/7.1
                    20, 21, // Row 6/7.2
                    20, 21,  // Row 6/7.3
                    18, 19, 20, 21 };  // Row 6/7.4
        int[] bld_large_y_unity = {8, 8, 8, 8,  // Row 3/4.1
                   9, 9, 9, 9, // Row 3/4.2
                   18, 18, 18, 18, // Row 6/7.1
                   19, 19, 19, 19, // Row 6/7.2
                   20, 20, // Row 6/7.3
                   21, 21 }; // Row 6/7.4
